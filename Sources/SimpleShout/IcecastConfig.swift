...
struct IcecastConfig: Codable {
    ...
    static func load(from path: String) throws -> IcecastConfig {
        ...
        do {
            ...
            throw SimpleShoutError(message: "Couldn't read config file at \(path): \(error.localizedDescription)")
        }
        ...
        do {
            ...
            throw SimpleShoutError(message: "Couldn't parse TOML config at \(path): \(error)")
        }
    }
}
